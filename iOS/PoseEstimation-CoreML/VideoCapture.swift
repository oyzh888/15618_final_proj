...
public class VideoCapture: NSObject {
    ...
    func setUpCamera(sessionPreset: AVCaptureSession.Preset, cameraPosition: AVCaptureDevice.Position, isMirror: Bool, completion: @escaping (_ success: Bool) -> Void) {
...
//        captureDevice.unlockForConfiguration()
        ...
        //For front camera
        videoOutput.connection(with: AVMediaType.video)?.isVideoMirrored = isMirror
